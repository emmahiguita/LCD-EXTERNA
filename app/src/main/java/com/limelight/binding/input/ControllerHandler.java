...
public class ControllerHandler implements InputManager.InputDeviceListener, UsbDriverListener {
    ...
    private static void configureMotionSensors(InputDevice device, InputDeviceContext context) {
        if (device.getSensorManager().getDefaultSensor(Sensor.TYPE_ACCELEROMETER) != null ||
                device.getSensorManager().getDefaultSensor(Sensor.TYPE_GYROSCOPE) != null) {
            context.sensorManager = device.getSensorManager();
        }
    }
    ...
    private InputDeviceContext createInputDeviceContextForDevice(InputDevice dev) {
        ...
        if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU ||
            ...
            configureMotionSensors(dev, context);
        }
    ...
    class GenericControllerContext {
        ...
        public void toggleMouseEmulation() {
            ...
            Toast.makeText(activityContext, "Emulación de ratón: " + (mouseEmulationActive ? "ACTIVADA" : "DESACTIVADA"), Toast.LENGTH_SHORT).show();
