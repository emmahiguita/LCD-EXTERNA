...
public class NvHTTP {
    private static final java.util.Set<okhttp3.Call> activeCalls = java.util.Collections.synchronizedSet(new java.util.HashSet<okhttp3.Call>());

    public static void cancelAllActiveCalls() {
    ...
    private ResponseBody openHttpConnection(OkHttpClient client, HttpUrl baseUrl, String path, String query) throws IOException {
        ...
        Request request = new Request.Builder()
                ...
                .get()
                .build();
        okhttp3.Call call = performAndroidTlsHack(client).newCall(request);
