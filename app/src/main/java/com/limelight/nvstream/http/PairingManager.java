...
public class PairingManager {
    ...
    // PIN fijo para uso en red local (LAN). Decisión explícita del proyecto:
    // siempre se empareja con "9999" para no tener que leer un PIN distinto cada vez.
    // NOTA DE SEGURIDAD: un PIN constante reduce la protección anti-MITM del
    // handshake; aceptable solo en una red doméstica/controlada.
    public static final String FIXED_PIN = "9999";
