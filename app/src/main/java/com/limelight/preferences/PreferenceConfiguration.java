...
public class PreferenceConfiguration {
    ...
    private static final boolean DEFAULT_ABSOLUTE_MOUSE_MODE = true;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        // Audio dual: el checkbox "Reproducir audio en PC" controla si el sonido
        // suena también en los altavoces del ordenador (localAudioPlayMode=1)
        // o solo en el móvil (localAudioPlayMode=0).
        ...
        config.absoluteMouseMode = true; // Forzado para SmartDisplay AI (Sincronización 1:1)
