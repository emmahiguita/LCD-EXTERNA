...
class KeyboardProfileEngine(
    ...
    private fun antigravityKeys(): List<DevKey> {
        return listOf(
            ...
            chord("Terminal", "Ctrl+`", "Terminal integrado", Win32VirtualKey.VK_OEM_3, RemoteModifier.CTRL, source = RemoteKeySource.INHERITED),
    ...
    private fun vsCodeKeys(): List<DevKey> {
        return listOf(
            ...
            chord("Terminal", "Ctrl+`", "Toggle Integrated Terminal", Win32VirtualKey.VK_OEM_3, RemoteModifier.CTRL),
